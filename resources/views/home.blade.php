                    ...
                    <div class="col-md-4 mt-2">
                        <div class="shadow card rounded border border-dark bg-success" id="card">
                            <div class="card-body mx-auto">
                                <a class="text-white" href="Bisection" id="card-link">Bisection Method</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mt-2">
                        <div class="shadow card rounded border border-dark  bg-success" id="card">
                            <div class="card-body mx-auto">
                                <a class="text-white" href="FalsePosition" id="card-link">False-Position Method</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mt-2">
                        <div class="shadow card rounded border border-dark  bg-success" id="card">
                            <div class="card-body mx-auto">
                                <a class="text-white" href="OnePointIteration" id="card-link">Simple One-Point Iteration</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mt-2">
                        <div class="shadow card rounded border border-dark  bg-success" id="card">
                            <div class="card-body mx-auto">
                                <a class="text-white" href="NewtonRarpson" id="card-link">Newton-Ralphson Method</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mt-2">
